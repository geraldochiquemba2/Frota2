...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="p-4 border-t border-border/50">
        ...
        <Button variant="outline" className="w-full justify-start text-muted-foreground hover:text-white border-border/50" onClick={logout}>
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex w-64 flex-col bg-card border-r border-border shadow-2xl shadow-black/50 z-20">
        <SidebarContent />
      </aside>
